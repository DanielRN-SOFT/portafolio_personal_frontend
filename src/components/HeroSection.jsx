...
const HeroSection = () => {
  ...
  return (
    <div className="relative min-h-screen w-full overflow-hidden bg-linear-to-b from-base-300 via-base-200 to-base-100 flex items-center justify-center px-4 py-20">
